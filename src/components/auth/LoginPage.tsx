        ...
        <div className="w-full max-w-3xl bg-slate-900/80 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 backdrop-blur-xl">
          ...
          <div className="lg:col-span-7 p-5 sm:p-7 flex flex-col justify-center bg-slate-900/60">
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              {/* Google SSO / Firebase Auth Enterprise Button */}
              <div className="space-y-2 pt-1">
                <div className="relative flex py-1 items-center">
                  <div className="flex-grow border-t border-slate-800"></div>
                  <span className="flex-shrink mx-2 text-[10px] uppercase font-mono tracking-wider text-slate-500 font-bold">
                    Atau Otentikasi Enterprise SSO
                  </span>
                  <div className="flex-grow border-t border-slate-800"></div>
                </div>
                ...
                <button
                  type="button"
                  onClick={() => {
                    // Google SSO / Firebase Auth auto sign in for current active user
                    setEmail('siska.rakaciptaseraya@gmail.com');
                    setPassword('google-sso-verified');
                  }}
                  className="w-full bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-200 hover:text-white font-bold text-xs py-2 px-3 rounded-lg transition flex items-center justify-center gap-2 group"
                >
                  ...
                  <span>Masuk Dengan Google Workspace SSO</span>
                  <span className="bg-emerald-500/20 text-emerald-300 text-[9px] px-1.5 py-0.5 rounded border border-emerald-500/30 font-mono font-normal ml-auto">
                    MFA ENFORCED
                  </span>
                </button>
              </div>
